              ...
              children: [
                Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Text(
                          AppLocalizations.of(context)?.translate("Welcome Back") ?? "Welcome Back,",
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text(
                                AppLocalizations.of(context)?.translate("BMI") ?? "BMI (Body Mass Index)",
                                style: TextStyle(
                                    color: TColor.white,
                                    fontSize: 14,
                                    fontWeight: FontWeight.w700),
                              ...
                              Text(
                                  AppLocalizations.of(context)?.translate("You normal") ?? "You have a normal weight",
                                style: TextStyle(
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        AppLocalizations.of(context)?.translate("Today Target") ?? "Today Target",
                        style: TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.w700),
                      ),
                ...
                Text(
                  AppLocalizations.of(context)?.translate("Activity Status") ?? "Activity Status",
                  style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.w700),
                ),
                          ...
                          children: [
                            ...
                            Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      AppLocalizations.of(context)?.translate("Water Intake") ?? "Water Intake",
                                      style: TextStyle(
                                          color: TColor.black,
                                          fontSize: 12,
                                          fontWeight: FontWeight.w700),
                                    ...
                                    Text(
                                      AppLocalizations.of(context)?.translate("Real time updates") ?? "Real time updates",
                                      style: TextStyle(
                                        color: TColor.gray,
                                        fontSize: 12,
                                      ),
                          ...
                          children: [
                            Container(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    Text(
                                      AppLocalizations.of(context)?.translate("Sleep") ?? "Sleep",
                                      style: TextStyle(
                                          color: TColor.black,
                                          fontSize: 12,
                                          fontWeight: FontWeight.w700),
                ...
                Row(
                  ...
                  children: [
                    Text(
                      AppLocalizations.of(context)?.translate("Workout Progress") ?? "Workout Progress",
                      style: TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.w700),
                    ),
                    Container(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton(
                            items: [AppLocalizations.of(context)?.translate("Weekly") ?? "Weekly",
