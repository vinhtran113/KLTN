...
import 'package:fitness_workout_app/view/login/medical_history_view.dart';
...
class ChooseActivityLevelView extends StatefulWidget {
  ...
  @override
  State<ChooseActivityLevelView> createState() =>
      _ChooseActivityLevelViewState();
}
                    ...
                    onPressed: () async {
                      ...
                      if (result == "success") {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const MedicalHistoryView(),
                          ),
                        );
                      } else {
