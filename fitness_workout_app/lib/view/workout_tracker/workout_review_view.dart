...
class WorkoutReviewView extends StatefulWidget {
  final String workoutId;

  const WorkoutReviewView({super.key, required this.workoutId});

  @override
  State<WorkoutReviewView> createState() => _WorkoutReviewViewState();
}

class _WorkoutReviewViewState extends State<WorkoutReviewView> {
