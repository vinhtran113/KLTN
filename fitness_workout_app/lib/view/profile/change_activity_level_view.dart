...
class ChangeActivityLevelView extends StatefulWidget {
  ...
  @override
  State<ChangeActivityLevelView> createState() =>
      _ChangeActivityLevelViewState();
}
...
class _ChangeActivityLevelViewState extends State<ChangeActivityLevelView> {
  ...
  void _loadData() async {
    ...
    if (widget.goal == "Lightly Active") {
      currentIndex = 1;
    }
    if (widget.goal == "Moderately Active") {
      currentIndex = 2;
    }
    if (widget.goal == "Very Active") {
      currentIndex = 3;
    }
    if (widget.goal == "Extra Active") {
      currentIndex = 4;
    }
  }
