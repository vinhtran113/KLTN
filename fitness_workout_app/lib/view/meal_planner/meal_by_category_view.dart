...
class MealsByCategoryView extends StatefulWidget {
  ...
  const MealsByCategoryView({super.key, required this.categoryName, required this.mObj});
    ...
    setState(() {
      if (keyword.isEmpty) {
        ...
        filteredMeals = allMealByCateArr.where((meal) =>
            meal.recommend.contains(widget.mObj["name"].toLowerCase())).toList();
      } else {
        filteredMeals = allMealByCateArr.where((meal) =>
        ...
        headerSliverBuilder: (context, innerBoxIsScrolled) {
          return [
            SliverAppBar(
              ...
              title: Text(
                AppLocalizations.of(context)?.translate("${widget.categoryName} of ${widget.mObj["name"]}") ?? "${widget.categoryName} of ${widget.mObj["name"]}",
